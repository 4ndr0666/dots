...
mp.observe_property("mouse-pos", "native", function () draw_cropper() end)
mp.observe_property("osd-width",  "native", function () draw_cropper() end)
mp.observe_property("osd-height", "native", function () draw_cropper() end)

mp.register_event("mouse_move", draw_cropper)

mp.add_key_binding("r", "easy_crop", easycrop_activate)
