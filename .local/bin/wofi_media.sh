...
browse_media() {
    ...
    while true; do
        ...
        if [[ "$selection" == "Exit" || -z "$selection" ]]; then
            ...
            case "$action" in
            "Play Now") play_media "$selection"; break ;; 
            "Queue in mpv") queue_media "$selection" ;; 
            "Back") ;; 
            *) ;; 
            esac
        else
